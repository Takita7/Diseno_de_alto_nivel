...
static constexpr uint32_t IMAGE_RGB_SIZE = IMAGE_WIDTH * IMAGE_HEIGHT * 3; // 1920 x 1080 x RGB_value | ~6 MB
...
SC_MODULE(Storage) {
    ...
    void set_directories(const std::string& in, const std::string& out){
        input_dir = in;
        output_dir = out;
    }
