...
│   │   ├── kernel_programs.h    ready-to-launch kernel library 
...
make regression # build + run full regression suite
...
`executeWarp` is called. The following registers are **pre-set**.
